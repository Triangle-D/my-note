...
class NoteTree(customtreectrl.CustomTreeCtrl):
    def __init__(self, parent):
        ...
        self.root = self.AddRoot("所有便签", data=Notebook())
    ...
    def _init_popup_menu(self):
        ...
        self.menu.Append(self.menu_id_create_notebook, '创建便签集')
        self.menu.Append(self.menu_id_edit_notebook, '编辑便签集')
        self.menu.Append(self.menu_id_delete_notebook, '删除便签集')
